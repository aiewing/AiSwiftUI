...
/*
 Cocoa 开发中协议-委托 (protocol-delegate) 模式是一种常用的设计模式，它贯穿于整个 Cocoa 框架中，为代码之间的关系清理和解耦合做出了不可磨灭的贡献。
...
// error: 'weak' must not be applied to non-class-bound 'MyClassDelegate';
